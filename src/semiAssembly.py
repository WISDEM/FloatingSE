...
class SemiAssembly(Group):
    ...
    def __init__(self):
        ...
        self.connect('water_density.x', ['mm.water_density', 'base.water_density', 'ball.water_density', 'sm.water_density'])
        ...
        self.connect('material_density.x', ['base.material_density', 'ball.material_density'])
        self.connect('E.x', ['base.E', 'ball.E'])
        self.connect('nu.x', ['base.nu', 'ball.nu'])
        self.connect('yield_stress.x', ['base.yield_stress', 'ball.yield_stress'])
        ...
        self.connect('number_of_ballast_columns.x', 'sm.number_of_ballast_cylinders')

        # Link outputs from one model to inputs to another
        self.connect('sg.fairlead_radius', 'mm.fairlead_radius')
        self.connect('sg.base_z_nodes', 'base.z_nodes')
        self.connect('sg.base_z_section', 'base.z_section')
        self.connect('sg.ballast_z_nodes', 'ball.z_nodes')
        ...
        self.connect('turb.surge_force', 'sm.turbine_surge_force')
        self.connect('turb.force_points', 'sm.turbine_force_points')
        ...
        self.connect('base.displaced_volume', 'sm.base_cylinder_displaced_volume')
        self.connect('base.total_mass', 'sm.base_cylinder_mass')
        ...
        self.connect('ball.displaced_volume', 'sm.ballast_cylinder_displaced_volume')
        self.connect('ball.total_mass', 'sm.ballast_cylinder_mass')
