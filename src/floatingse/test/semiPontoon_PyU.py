...
class TestStructure(unittest.TestCase):
    def setUp(self):
        ...
        self.params['base_column_mass'] = 1e2 * np.ones((NSECTIONS+1,))
        self.params['ballast_column_mass'] = 1e1 * np.ones((NSECTIONS+1,))
        ...
        self.params['base_column_displaced_volume'] = 1e2
        self.params['ballast_column_displaced_volume'] = 1e1
